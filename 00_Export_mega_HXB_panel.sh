...
for i in F344_DuCrl F344_NCrl F344_NHsd dss_denovo_multi fhh_denovo_multi bn_denovo_multi ACI_N BN-Lx_Cub SHR_OlaIpcv BXH10 BXH11 BXH12 BXH13 BXH2 BXH3 BXH5 BXH6 BXH8 BXH9 HXB1 HXB10 HXB13 HXB15 HXB17 HXB18 HXB2 HXB20 HXB21 HXB22 HXB23 HXB24 HXB25 HXB27 HXB29 HXB3 HXB31 HXB4 HXB5 HXB7;  do
    if [ ! -f /lustre/haven/proj/UTHSC0013/supernova_results/${i}_supernova_megabubble.fasta.gz ] ; then 
        supernova mkoutput --style=megabubbles --asmdir=/lustre/haven/proj/UTHSC0013/supernova_results/$i/outs/assembly/ --outprefix=/lustre/haven/proj/UTHSC0013/supernova_results/${i}_supernova_megabubble --minsize=1000 --headers=full 
